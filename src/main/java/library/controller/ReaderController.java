...
public class ReaderController {
    ...
    //假如用POST方法那么search后面不能加参数，假如search后面加个{readerid}，那么必须用get
    //get有长度限制，POST没有长度限制
   ...
   /* @RequestMapping(value = "/search", method = RequestMethod.POST)
    public ModelAndView getReaderInfo(int readerid) throws IOException, SQLException {
        ...
        List<Relation>  relation= lendBookMapper.selectRelationByReaderid(readerid);
        showDatas.put("relations", relation);
        showDatas.put("readers", reader);
        return new ModelAndView("reader/searchshowaboutreader", showDatas);
    }*/
